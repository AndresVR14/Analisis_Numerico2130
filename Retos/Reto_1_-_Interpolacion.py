...
#Extraer datos                                                            
DC1P, DC2P, DC3P = clasificarDatos("Datos.xlsx", "Itatira", "Dia Juliano", "Temp. Interna (ºC)", "Hora")
...
#SEGUDO PUNTO
#Extraer datos    
DC1S, DC2S, DC3S = clasificarDatos("Datos.xlsx", "Quixadá", "Dia Juliano", "Temp. Interna (ºC)", "Hora")
...
'''for i in range(len(columna2AS)): Ajuste de datos
